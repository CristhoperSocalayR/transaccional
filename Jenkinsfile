pipeline {
    ...
    environment {
        ...
        PROJECT_KEY = 'CristhoperSocalayR_transaccional'  // Nombre corregido del proyecto en SonarCloud
    ...
    stages {
        stage('Clone Repository') {
            steps {
                ...
                git branch: 'main', url: 'https://github.com/CristhoperSocalayR/transaccional.git'
            }
        }
        ...
        stage('Run Unit Tests') {
            steps {
                sh '''
                    mvn test \
                        -Dtest=TypeKardexApplicationTests
                '''
            }
            post {
                always {
                    ...
                    withSonarQubeEnv("${env.SONARQUBE}") {
                        sh '''
                            mvn sonar:sonar \
                                ...
                                -Dsonar.projectName=transaccional \
